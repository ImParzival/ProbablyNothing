...
public class BitqueryClient {
	...
	public DexTradeDTO getDexTrades(ContestHeader contestHeader, String startDate, String endDate) throws IOException {
		...
		graphqlRequestBody.setVariables(variables.replace("exchangeName", EXCHANGE_NAME)
				.replace("baseCurrency", contestHeader.getTokenContract()).replace("quoteCurrency", WETH_TOKEN)
